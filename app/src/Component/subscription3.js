...
<NavLink style={{textDecoration:'none' , color:'#A8A8A8'}} to='/subscription3' activeClassName="selected"
 activeStyle={{
    fontWeight: "bolder",
    color: "blue",
...
<div className='col-4 offset-8' style={{
    marginTop:'-10px'}}>
<h3><b><EuroSymbolIcon  style={{fontsize:'30px' , marginTop:'-5px'}} ></EuroSymbolIcon> 357</b></h3>
...
<div className='col-4 p-3' style={{backgroundColor:'#2143FB' , color:'#F5F5F5' , 
 width:'330px' , 
height:'500px'}} id='sb1'>
...
<div className='col-4 offset-8' style={{
    marginTop:'-10px'}}>
<h3><b><EuroSymbolIcon  style={{fontsize:'30px' , marginTop:'-5px'}} ></EuroSymbolIcon> 457</b></h3>
<p style={{marginTop:'-9px' , marginLeft:'6px'}}>/ &nbsp; Month</p>
</div>
...
<div className='col-4 offset-8' style={{
    marginTop:'-10px'}}>
<h3><b><EuroSymbolIcon  style={{fontsize:'30px' , marginTop:'-5px'}} ></EuroSymbolIcon> 557</b></h3>
<p style={{marginTop:'-9px' , marginLeft:'6px'}}>/ &nbsp; Month</p>
</div>
...
<h6><a href='/subscription2' style={{color:'black' , textDecoration:'none'}} >
  <ArrowBackIcon></ArrowBackIcon><br></br>Check more</a></h6>
</div>


<div className='row'>
<div className='col-sm-5 col offset-9' id='other'>
<h6><a style={{textDecoration:'none' , color:'black'}} href='/subscription4' id='arrow'>
  <ArrowForwardIcon></ArrowForwardIcon><br></br><a href='/subscription4' 
