...
<h6><Link to='/subscription2' style={{color:'black' , textDecoration:'none'}} >
...
<h6><Link style={{textDecoration:'none' , color:'black'}} to='/subscription4' id='arrow'>
  <ArrowForwardIcon></ArrowForwardIcon><br></br><Link to='/subscription4' 
