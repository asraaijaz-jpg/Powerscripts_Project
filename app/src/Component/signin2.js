...
fetch("https://gencore.ar/micro_services_new/public/api/login",
{
    ...
    return(<div>
        <div className='container-fluid' >
            ...
            <div className='col-lg-6' style={{ color:'white' , backgroundColor:'blue'}} id='blc1'>
            ...
            <div className='col-lg-4 col-12 offset-5 p-3'>
                ...
                <Link to='/loginpage'> <button type="button" className="btn btn-outline-primary " id='btnwid4'>
    ...
    <input type="email" class="form-control" id="Email" placeholder="lindsey.westerveltgmail.com"
...
<button type="submit" class="btn btn-primary mb-2 btn-lg" id='btnwid'
 style={{backgroundColor:'#2143FB'}} onClick={check}> Sign In
    </button><br></br><br></br>
...
{/* 
        ...
        <img src={logo7} style={{marginTop:'-100px'  , marginLeft:'70px'}}></img>
        </div> */}
