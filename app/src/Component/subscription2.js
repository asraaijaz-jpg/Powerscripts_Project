...
function Subscription2()
{
  ...
  <p style={{fontSize:'13px'}}> Linkedin Text Ads..</p>
    ...
    <p style={{fontSize:'13px'}}>
     <span>  <Link to
     ='/profile1' style={{textDecoration:'none' , color:'black'}}>Profile</Link></span>
      <br></br>
     <span>  <Link to
     ='/order1' style={{textDecoration:'none' , color:'black'}}>Orders</Link></span>
    <br></br>
   <span>  <Link to
   ='/support' style={{textDecoration:'none' , color:'black'}}>Support</Link></span>
   </p>
...
<div className='row' id='profiles'>
        ...
        <Link to
        ='/profile1' style={{textDecoration:'none' , color:'black'}}>
...
style={{color:'blue' , width:'295px' , marginTop:'-101px' , border:'1px solid blue' , 
...
<h6><Link style={{textDecoration:'none' , color:'black'}} to='/subscription3' id='arrow'>
  <ArrowForwardIcon></ArrowForwardIcon><br></br><Link to='/subscription3' 
...
<div className='row'>
     ...
     <h5 style={{fontSize:'18px' }}><Link to
     ='' style={{textDecoration:'none' , color:'black'}} 
     ...
     <h5 style={{fontSize:'18px' }}><Link to
     ='' style={{textDecoration:'none' , color:'black'}}id='modaltxt'
