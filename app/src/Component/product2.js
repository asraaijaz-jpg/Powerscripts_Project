...
<select class="form-select" aria-label="Default select example">
  <option selected>Default (English)</option>
...
backgroundColor:'#2143FB'}} onClick={handleShow2} 
><a href='' style={{textDecoration:'none' , color:'white' }} >Open Now</a></button>
</center>
</div>
...
width:'100px' , marginLeft:'1220px' , marginTop:'-650px'}}></img> */}



{/* 
<div className='row'>
<div className='col offset-10' style={{marginTop:'-380px' }}>
<a href=''><img src={logo3} style={{height:'210px' , 
width:'210px'  , marginLeft:'140px'}}></img></a>
</div>
</div>
...
<img src={logo4} style={{height:'230px' , 
width:'200px' , marginLeft:'50px'}}></img>
</div>
</div>

<div className='row'>
<div className='col offset-10' style={{marginTop:'-160px' , marginLeft:'1100px' }}>
<img src={logo5} ></img>
</div>
</div>

<div className='row'>
<div className='col offset-10' style={{marginTop:'-80px' , marginLeft:'1200px' }}>
<img src={logo6}></img>
</div>
</div>  */}
