    ...
    if(a.match(pattern) && (b.match(pattern2)))
{
    ...
    return(<div>
        <div className='container-fluid'>
            <div className='row' style={{display:'flex' , backgroundColor:'#F1F972'}}>


            <div className='col-lg-6' style={{ color:'blue' , backgroundColor:'#F1F972 '}} id='blc1'>
        

            <img className='p-5' src={logoo} id='up'></img>
             <h3 className='text-center' id='t1'>Write Like <br></br>a <i> SUPERHERO</i></h3><br></br>
             <p className='text-center' id='t2'>Lorem ipsum dolor 
             sit ament<br></br> consectutur adipiscing elit. Mauris</p>
             <br></br>
    ...
    <input type="text" class="form-control" id="name" placeholder="Name"  style={{height:'40px'
    , border: '2px solid #CACACA' , borderRadius:'4px'}}
...
<button type="submit" class="btn btn-primary mb-2 btn-lg" id='btnwid'
 style={{backgroundColor:'#2143FB'}} onClick={check}>
    ...
    >
       ...
       >
            <img src={linked}/></a></button>  </div>

        {/* <div className='col-2 offset-1'>
        <img src={logo1} style={{marginTop:'-80px'  , marginLeft:'30px'}}
        style={{height:'80px' , width:'70px'}}></img>
        <img src={logo7} style={{marginTop:'-100px'  , marginLeft:'120px'}}
...
{/*         
<div className='row'>
<div className='col offset-10' style={{marginTop:'-570px'  , marginLeft:'580px'}}>
<img src={logo2} style={{height:'120px' , width:'50px'}}></img>
</div>
</div>

<div className='row'>
<div className='col offset-10' style={{marginTop:'-400px'  , marginLeft:'500px'}}>
<img src={logo3} style={{height:'180px' , width:'160px'}}></img>
</div>
</div>
...
<div className='row'>
<div className='col offset-10' style={{marginTop:'-190px'  , marginLeft:'600px'}}>
<img src={logo1} style={{height:'100px' , width:'60px'}}></img>
</div>
</div>

  
<div className='row'>
<div className='col offset-10' style={{marginTop:'-90px'  , marginLeft:'620px'}}>
<img src={logo7} style={{height:'30px' , width:'30px'}}></img>
</div>
</div> */}
    </div>
